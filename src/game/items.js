...
export const ITEMS = {
  ...
  relic: { cat: 'artifact', stack: 20, price: 900, color: '#7fe8ff', glyph: 'Rl' },
  fossil: { cat: 'sample', stack: 20, price: 450, color: '#e8dcc0', glyph: 'Fs' },
  crystal_core: { cat: 'resource', stack: 50, price: 220, color: '#9fe8ff', glyph: 'Cr' },
